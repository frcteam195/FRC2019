package com.team195.lib.util.TrajectoryFollowingMotion;
...
public class MotionSegment {
    ...
    public boolean isValid() {
        ...
        if (Math.signum(start().vel()) * Math.signum(end().vel()) < 0.0 && !Util.epsilonEquals(start().vel(), 0.0, MotionUtil.kEpsilon)
